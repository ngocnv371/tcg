...
insert into public.cards (id, name, rank, faction, role, base_atk, base_def, passive_name, passive_text, lore, tags, art_path, sort_order) values
  ('cinder_squire', 'Cinder Squire', 1, 'ember', 'dps', 20, 12, 'Ember Strike', '+15% ATK against 1★ and 2★ enemies.', 'A page who never lets the forge go cold.', '{Fire,Human,Knight}', 'art/cards/cinder_squire.webp', 0),
  ('ash_hound', 'Ash Hound', 1, 'ember', 'dps', 21, 11, 'Cinder Trail', '+5% party power for each other Ember card in the party.', 'It sleeps in the cooling slag and wakes at the smell of iron.', '{Fire,Beast}', 'art/cards/ash_hound.webp', 1),
  ('tidepool_sprite', 'Tidepool Sprite', 1, 'tide', 'support', 17, 14, 'Tidal Mend', 'Heals the party for 4% of its power after each successful run.', 'Small enough to hide in a seashell, loud enough to wake a harbour.', '{Water,Spirit}', 'art/cards/tidepool_sprite.webp', 2),
  ...
  ('shade_rat', 'Shade Rat', 1, 'umbral', 'dps', 19, 11, 'Gnaw', 'Ignores 10% of enemy DEF.', 'It eats the light before it eats the grain.', '{Dark,Beast}', 'art/cards/shade_rat.webp', 6),
  ...
  ('ashen_sovereign', 'Ashen Sovereign', 5, 'ember', 'dps', 130, 68, 'Crownfire', '+30% power on boss dungeons and boss cores are guaranteed on a clear.', 'The first forge was lit to crown it, not to warm anyone.', '{Fire,Dragon}', 'art/cards/ashen_sovereign.webp', 28),
